 ...
 * leaflet should land on, which is why it holds the root of hearfy.org and
 * the demo sits at `/demo` (moved 2026-09-03). The old `/one-pager` URL was
 * public, so it survives as a redirect stub rather than a 404.
 *
 ...
 * benefit. `asset()` is mandatory for a raw src: it is a no-op while the site
 * serves from the apex of hearfy.org, and the one edit that saves every raw
 * URL here if a basePath ever comes back.
 */
function Photo({
  src,
  alt,
